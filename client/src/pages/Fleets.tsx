        ...
        <div className="relative z-10 px-4">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 mb-16">
            {features.map((feature) => {
              ...
              return (
                <div key={feature.title} className="bg-card border border-card-border rounded-lg p-6 text-center hover:shadow-lg transition-shadow">
          ...
          <div>
            <h2 className="text-2xl md:text-3xl font-bold text-foreground mb-10 text-center">Our Luxury Cars</h2>
            <div className="grid md:grid-cols-3 gap-8">
              {paginatedCars.map((car) => (
                <div key={car.id} className="bg-white border border-border rounded-2xl overflow-hidden shadow-sm hover:shadow-lg transition-shadow">
            ...
            <div className="flex items-center justify-center mt-10 gap-4">
              <button onClick={handlePrev} className="bg-primary text-white rounded-full w-10 h-10 flex items-center justify-center hover:bg-primary/80 transition">❮</button>
              <div className="text-lg font-medium text-foreground">{currentPage + 1} / {totalPages}</div>
              <button onClick={handleNext} className="bg-primary text-white rounded-full w-10 h-10 flex items-center justify-center hover:bg-primary/80 transition">❯</button>
            </div>
          </div>
        </div>
      </section>

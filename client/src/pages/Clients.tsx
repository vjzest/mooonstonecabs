...
const clientTypes = [
  {
    ...
    description: 'Leading companies trust us for employee transportation and executive travel',
    count: '50+',
  },
  {
    icon: Briefcase,
    title: 'Business Professionals',
    description: 'Entrepreneurs and executives rely on our premium services',
    count: '200+',
  },
  {
    icon: Users,
    title: 'Event Organizers',
    description: 'Major events and exhibitions choose our logistics expertise',
    count: '100+',
  },
  {
    icon: Star,
    title: 'Individual Customers',
    description: 'Thousands of satisfied customers for personal transportation',
    count: '5000+',
  },
];
  ...
  return (
    <div className="min-h-screen">
      ...
      <section
        ...
        style={{
          backgroundImage: "url('/assets/client-banner.jpg')",
        }}
      >
      ...
      {/* 🆕 CUSTOM INFO SECTION (before Book a Ride) */}
        ...
        <div className="max-w-6xl mx-auto px-4 grid md:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <p className="text-muted-foreground mb-6 leading-relaxed">
              We redefine luxury on wheels with our modern fleet, professional chauffeurs, and
              unparalleled comfort. Whether it’s business meetings, airport transfers, or special occasions — 
      ...
      {/* ✅ EXISTING CLIENT COUNT + BOOK RIDE SECTION */}
          ...
          >
            ...
            <a href="/booking">
              <button
                ...
                data-testid="button-clients-book"
              >
                Book Your Ride
              </button>
            </a>

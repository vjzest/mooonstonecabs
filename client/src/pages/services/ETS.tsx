...
const features = [
  {
    ...
    description: "On-time pickup and drop for employee commutes",
  },
  {
    icon: Shield,
    title: "Safe & Secure",
    description: "GPS tracking and verified drivers for employee safety",
  },
  {
    icon: Users,
    title: "Flexible Routes",
    description: "Customizable routes based on employee locations",
  },
  {
    icon: Zap,
    title: "Quick Response",
    description: "Fast deployment and responsive customer support",
  },
];

export default function ETS() {
  // REF FOR LOWER SECTION
    ...
    <div className="min-h-screen">
      ...
      >
        ...
        <div className="relative z-10 px-4">
          ...
          >
            Reliable, safe, and efficient employee transportation solutions for
            corporate clients
          </motion.p>
        </div>
      </section>
      ...
      <Breadcrumb
        items={[{ label: "Services" }, { label: "Employee Transportation (ETS)" }]}
      />
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center mb-16">
            ...
            >
              <p className="text-lg text-muted-foreground leading-relaxed">
                Our Employee Transportation Services (ETS) provide comprehensive
                transport solutions for organizations looking to ensure safe and
                timely commutes for their workforce.
              </p>

              <p className="text-lg text-muted-foreground leading-relaxed">
                We understand the importance of employee well-being and
                productivity, which is why we offer customizable, reliable, and
                professional transportation services tailored to your
            ...
            {[
              {
                ...
                desc: "We analyze company routes, shifts, and staff locations.",
              },
              {
                icon: MapPin,
                title: "Route Planning",
                desc: "Our system generates efficient and safe routes for all employees.",
              },
              {
                icon: Headphones,
                title: "Live Monitoring",
                desc: "24x7 tracking, updates, and support during all rides.",
              },
            ].map((step, index) => {
